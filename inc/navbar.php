...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#" id="marca_del_producto"><img src="./img//logo_storange1.png" style="width: 100px;></a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li id="elem_ajustes" class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="./licencia"><i class="fa fa-certificate"></i> Licencia PRO</a></li>
                    </ul>
                </li>
                <li class="dropdown">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="well">
                    ...
                    <br>
                    <h2>Power By <a target="_blank" href="https://storange.net/">Storange</a></h2>
                </div>
            </div>
