    ...
    <div class="col-xs-12">
        ...
        <div class="form-group">
            <label for="impresoras">
                <strong>Nota: </strong> Elige solamente impresoras físicas.
            </label>
            <select class="form-control" enable name="impresoras" id="impresoras">
...
<div class="row">
    ...
    <div class="col-xs-12">
        ...
        <div class="form-group">
            <label for="colonia">Barrio</label><input placeholder="Colonia" type="text" id="colonia"
                                                       class="form-control">
        </div>
        <div class="form-group">
