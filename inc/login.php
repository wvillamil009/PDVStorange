...
<div class="text-center">
                  <img src="./img/logo_storange2.png"
                    style="width: 185px;" alt="logo">
                  <h4 class="mt-1 mb-5 pb-1">POS Storange</h4>
                </div>

<div class="col-md-4 col-md-offset-4 col-xs-12">
  <h3 class="text-center">login </i></h3>
    <div class="col-md-12">
    ...
    <div class="col-md-12">
        <button id="iniciar_sesion" class="form-control btn btn-primary">Iniciar sesión <i class="fa fa-sign-in"></i>
        </button>
        <br><br>
        <a class="text-center" href="https://storange.net/contacto/" class="link-primary">Copyright © Storange GROUP</a>
    </div>
</div>
