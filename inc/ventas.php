    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="btn-group btn-group-justified">
                <div class="btn-group">
                    <button id="quitar_ultimo_producto" type="button" class="btn btn-primary">
            ...
            <div class="form-group">
                <label for="codigo_producto">Escanea o busca producto</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <button id="realizar_venta" class="form-control btn btn-primary">Realizar venta</button>
                    </div>
                </div>
            </div>
        </div>
