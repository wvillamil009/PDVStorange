...
if (!file_exists(RAIZ . "/config.php")) {
    if (isset($_SESSION["hora_de_inicio"]) and ((time() - $_SESSION["hora_de_inicio"]) / 300) <= MINUTOS_EXPIRACION_SESION) {
        ...
        $lista_blanca = array("licencia", "pasar-inventario", "alta-de-inventarios", "caja", "clientes", "compras", "inventarios", "ventas", "reportes-inventarios", "reportes", "reportes-caja", "reportes-ventas", "gastos", "ajustes", "reportes-gastos", "reportes-bajas-inventario", "usuarios", "productos-en-stock");
